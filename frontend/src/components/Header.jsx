      ...
      <nav className="navbar section-content">
        ...
        <ul className="nav-menu">
          ...
          <li className="nav-item">
            <NavLink to="/home" className="nav-link" onClick={handleNavLinkClick}>
              Home
            </NavLink>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <NavLink to="/order" className="nav-link" onClick={handleNavLinkClick}>
              Order
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/merchandise" className="nav-link" onClick={handleNavLinkClick}>
              Merchandise
            </NavLink>
          </li>
          <li className="nav-item">
